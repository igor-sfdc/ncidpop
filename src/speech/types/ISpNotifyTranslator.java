...
public interface ISpNotifyTranslator extends speech.types.ISpNotifySink
{
    // Methods:
    /**
    ...
    @VTID(4)
    void initWindowMessage(int hWnd, int msg, int wParam, int lParam);
    ...
    @VTID(5)
    void initCallback(Holder<java.nio.Buffer> pfnCallback, int wParam,
            int lParam);
    ...
    @VTID(6)
    void initSpNotifyCallback(Holder<java.nio.Buffer> pSpCallback, int wParam,
            int lParam);
    ...
    @VTID(7)
    void initWin32Event(java.nio.Buffer hEvent, int fCloseHandleOnRelease);
