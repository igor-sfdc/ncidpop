...
public interface ISpeechRecoResult extends Com4jObject
{
    ...
    @VTID(9)
    void audioFormat(speech.types.ISpeechAudioFormat format);
    ...
    @VTID(12)
    speech.types.ISpeechPhraseAlternates alternates(int requestCount,
    ...
    @VTID(16)
    void discardResultInfo(speech.types.SpeechDiscardType valueTypes);
