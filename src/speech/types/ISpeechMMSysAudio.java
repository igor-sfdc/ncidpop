...
public interface ISpeechMMSysAudio extends speech.types.ISpeechAudio
{
    // Methods:
    /**
     * <p>
    ...
    @DISPID(300)
    // = 0x12c. The runtime will prefer the VTID if present
    @VTID(21)
    int deviceId();
    ...
    @DISPID(301)
    // = 0x12d. The runtime will prefer the VTID if present
    @VTID(23)
    int lineId();
    ...
    @DISPID(302)
    // = 0x12e. The runtime will prefer the VTID if present
    @VTID(25)
    int mmHandle();
