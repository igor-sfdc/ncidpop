...
public interface ISpRecoContext extends speech.types.ISpEventSource
{
    ...
    @VTID(14)
    speech.types.ISpRecoGrammar createGrammar(long ullGrammarID);
    ...
    @VTID(16)
    void getMaxAlternates(Holder<Integer> pcAlternates);
    ...
    @VTID(17)
    void setMaxAlternates(int cAlternates);
    ...
    @VTID(21)
    void bookmark(speech.types.SPBOOKMARKOPTIONS options,
            long ullStreamPosition, int lparamEvent);
    ...
    @VTID(25)
    void setVoice(speech.types.ISpVoice pVoice, int fAllowFormatChanges);
    ...
    @VTID(27)
    void setVoicePurgeEvent(long ullEventInterest);
    ...
    @VTID(29)
    void setContextState(speech.types.SPCONTEXTSTATE eContextState);

    /**
     * @param peContextState Mandatory Holder<speech.types.SPCONTEXTSTATE>
     *        parameter.
     */

    @VTID(30)
    void getContextState(Holder<speech.types.SPCONTEXTSTATE> peContextState);
