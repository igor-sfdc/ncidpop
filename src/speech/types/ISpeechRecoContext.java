...
public interface ISpeechRecoContext extends Com4jObject
{
    ...
    @VTID(10)
    void voice(speech.types.ISpeechVoice voice);
    ...
    @VTID(12)
    void allowVoiceFormatMatchingOnNextSet(boolean pAllow);
    ...
    @VTID(14)
    void voicePurgeEvent(speech.types.SpeechRecoEvents eventInterest);
    ...
    @VTID(16)
    void eventInterests(speech.types.SpeechRecoEvents eventInterest);
    ...
    @VTID(18)
    void cmdMaxAlternates(int maxAlternates);
    ...
    @VTID(20)
    void state(speech.types.SpeechRecoContextState state);
     ...
     * </p>
     * 
     * @param option Mandatory speech.types.SpeechRetainedAudioOptions
     *        parameter.
     */
    ...
    @VTID(22)
    void retainedAudio(speech.types.SpeechRetainedAudioOptions option);
    ...
    @VTID(24)
    void retainedAudioFormat(speech.types.ISpeechAudioFormat format);
    ...
    @VTID(30)
    void bookmark(speech.types.SpeechBookmarkOptions options,
    ...
    @VTID(31)
    void setAdaptationData(java.lang.String adaptationString);
