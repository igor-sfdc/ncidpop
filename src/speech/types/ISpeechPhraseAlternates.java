...
public interface ISpeechPhraseAlternates extends Com4jObject,
        Iterable<Com4jObject>
{
     ...
     * @return Returns a value of type speech.types.ISpeechPhraseAlternate
     */
    ...
    @VTID(8)
    @DefaultMethod
    speech.types.ISpeechPhraseAlternate item(int index);
