...
public interface ISpeechRecognizer extends Com4jObject
{
    ...
    @VTID(7)
    void recognizer(speech.types.ISpeechObjectToken recognizer);
    ...
    @VTID(9)
    void allowAudioInputFormatChangesOnNextSet(boolean allow);
    ...
    @VTID(16)
    void state(speech.types.SpeechRecognizerState state);
    ...
    @VTID(23)
    speech.types.ISpeechAudioFormat getFormat(speech.types.SpeechFormatType type);
    ...
    @VTID(24)
    boolean setPropertyNumber(java.lang.String name, int value);
    ...
    @VTID(25)
    boolean getPropertyNumber(java.lang.String name, Holder<Integer> value);
    ...
    @VTID(26)
    boolean setPropertyString(java.lang.String name, java.lang.String value);
    ...
    @VTID(27)
    boolean getPropertyString(java.lang.String name,
