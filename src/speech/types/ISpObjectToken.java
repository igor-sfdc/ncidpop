...
public interface ISpObjectToken extends speech.types.ISpDataKey
{
    // Methods:
    /**
    ...
    @VTID(15)
    void setId(@MarshalAs(NativeType.Unicode) java.lang.String pszCategoryId,
            @MarshalAs(NativeType.Unicode) java.lang.String pszTokenId,
            int fCreateIfNotExist);

    /**
     * @param ppTokenCategory Mandatory
     *        Holder<speech.types.ISpObjectTokenCategory> parameter.
     */

    @VTID(17)
    void getCategory(Holder<speech.types.ISpObjectTokenCategory> ppTokenCategory);
    ...
    @VTID(18)
    java.nio.Buffer createInstance(com4j.Com4jObject pUnkOuter,
            int dwClsContext, GUID riid);
    ...
    @VTID(20)
    void removeStorageFileName(GUID clsidCaller,
    ...
    int isUISupported(
            ...
            java.nio.Buffer pvExtraData, int cbExtraData,
