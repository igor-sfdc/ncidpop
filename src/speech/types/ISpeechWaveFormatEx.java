...
public interface ISpeechWaveFormatEx extends Com4jObject
{
    ...
    // = 0x1. The runtime will prefer the VTID if present
    @VTID(8)
    void formatTag(short formatTag);
    ...
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(12)
    void samplesPerSec(int samplesPerSec);
    ...
    // = 0x4. The runtime will prefer the VTID if present
    @VTID(14)
    void avgBytesPerSec(int avgBytesPerSec);
    ...
    // = 0x5. The runtime will prefer the VTID if present
    @VTID(16)
    void blockAlign(short blockAlign);
    ...
    // = 0x6. The runtime will prefer the VTID if present
    @VTID(18)
    void bitsPerSample(short bitsPerSample);
    ...
    // = 0x7. The runtime will prefer the VTID if present
    @VTID(20)
    void extraData(@MarshalAs(NativeType.VARIANT) java.lang.Object extraData);
