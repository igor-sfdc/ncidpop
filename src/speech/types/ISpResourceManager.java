...
public interface ISpResourceManager extends speech.types.IServiceProvider
{
    // Methods:
    /**
    ...
    @VTID(4)
    void setObject(GUID guidServiceId, com4j.Com4jObject punkObject);
    ...
    @VTID(5)
    java.nio.Buffer getObject(GUID guidServiceId, GUID objectCLSID,
            GUID objectIID, int fReleaseWhenLastExternalRefReleased);
