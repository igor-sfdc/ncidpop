...
public interface ISpGrammarBuilder extends Com4jObject
{
    ...
    @VTID(3)
    void resetGrammar(short newLanguage);
    ...
    java.nio.Buffer getRule(
            ...
            int dwRuleId, int dwAttributes, int fCreateIfNotExist);
    ...
    @VTID(5)
    void clearRule(java.nio.Buffer hState);
    ...
    @VTID(6)
    void createNewState(java.nio.Buffer hState, Holder<java.nio.Buffer> phState);
    ...
    @VTID(9)
    void addResource(java.nio.Buffer hRuleState,
