...
public interface ISpeechAudioFormat extends Com4jObject
{
     ...
     * </p>
     * 
     * @param audioFormat Mandatory speech.types.SpeechAudioFormatType
     *        parameter.
     */
    ...
    // = 0x1. The runtime will prefer the VTID if present
    @VTID(8)
    void type(speech.types.SpeechAudioFormatType audioFormat);
    ...
    // = 0x2. The runtime will prefer the VTID if present
    @VTID(10)
    void guid(java.lang.String guid);
    ...
    @VTID(12)
    void setWaveFormatEx(speech.types.ISpeechWaveFormatEx waveFormatEx);
