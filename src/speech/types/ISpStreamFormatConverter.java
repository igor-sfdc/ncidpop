...
public interface ISpStreamFormatConverter extends speech.types.ISpStreamFormat
{
    ...
    @VTID(15)
    void setBaseStream(speech.types.ISpStreamFormat pStream,
    ...
    @VTID(19)
    long scaleConvertedToBaseOffset(long ullOffsetConvertedStream);
    ...
    @VTID(20)
    long scaleBaseToConvertedOffset(long ullOffsetBaseStream);
