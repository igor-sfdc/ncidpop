...
public interface ISpeechRecoGrammar extends Com4jObject
{
     ...
     * </p>
     * 
     * @param state Mandatory speech.types.SpeechGrammarState parameter.
     */

    @DISPID(3)
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(9)
    void state(speech.types.SpeechGrammarState state);
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.SpeechGrammarState
     */

    @DISPID(3)
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(10)
    speech.types.SpeechGrammarState state();
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechGrammarRules
     */

    @DISPID(4)
    // = 0x4. The runtime will prefer the VTID if present
    @VTID(11)
    speech.types.ISpeechGrammarRules rules();

    @VTID(11)
    @ReturnValue(defaultPropertyThrough =
    { speech.types.ISpeechGrammarRules.class })
    speech.types.ISpeechGrammarRule rules(int index);
    ...
    @VTID(12)
    void reset(@Optional @DefaultValue("0") int newLanguage);
    ...
    void cmdLoadFromFile(
            ...
            @Optional @DefaultValue("0") speech.types.SpeechLoadOption loadOption);
     ...
     * @param state Mandatory speech.types.SpeechRuleState parameter.
     */

    @DISPID(12)
    // = 0xc. The runtime will prefer the VTID if present
    @VTID(18)
    void cmdSetRuleState(java.lang.String name,
            speech.types.SpeechRuleState state);
    ...
    @VTID(19)
    void cmdSetRuleIdState(int ruleId, speech.types.SpeechRuleState state);
    ...
    @VTID(22)
    void dictationSetState(speech.types.SpeechRuleState state);
     ...
     * @param info Mandatory speech.types.ISpeechTextSelectionInformation
     *        parameter.
     */
    ...
    @VTID(23)
    void setWordSequenceData(java.lang.String text, int textLength,
            speech.types.ISpeechTextSelectionInformation info);
    ...
    @VTID(24)
    void setTextSelection(speech.types.ISpeechTextSelectionInformation info);
     ...
     * @return Returns a value of type speech.types.SpeechWordPronounceable
     */

    @DISPID(19)
    // = 0x13. The runtime will prefer the VTID if present
    @VTID(25)
    speech.types.SpeechWordPronounceable isPronounceable(java.lang.String word);
