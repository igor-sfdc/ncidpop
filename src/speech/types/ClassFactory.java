...
public abstract class ClassFactory
{
    ...
    {
        return COM4J.createInstance(speech.types.ISpNotifyTranslator.class,
    ...
    public static speech.types.ISpeechObjectTokenCategory createSpObjectTokenCategory()
    {
        return COM4J.createInstance(
                speech.types.ISpeechObjectTokenCategory.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechObjectToken.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpResourceManager.class,
    ...
    {
        return COM4J.createInstance(
                speech.types.ISpStreamFormatConverter.class,
    ...
    {
        return COM4J.createInstance(speech.types.IEnumSpObjectTokens.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechMMSysAudio.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpObjectWithToken.class,
                "{FEE225FC-7AFD-45E9-95D0-5A318079D911}");
    }
    ...
    {
        return COM4J.createInstance(speech.types.ISpStream.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechVoice.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechRecoContext.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechRecognizer.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechLexicon.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpLexicon.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechPhoneConverter.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpPhoneConverter.class,
    ...
    {
        return COM4J.createInstance(
                speech.types.ISpeechTextSelectionInformation.class,
    ...
    {
        return COM4J.createInstance(
                speech.types.ISpeechPhraseInfoBuilder.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechAudioFormat.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechWaveFormatEx.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechCustomStream.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechFileStream.class,
    ...
    {
        return COM4J.createInstance(speech.types.ISpeechMemoryStream.class,
