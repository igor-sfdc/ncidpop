...
public interface ISpeechBaseStream extends Com4jObject
{
     ...
     * </p>
     * 
     * @param audioFormat Mandatory speech.types.ISpeechAudioFormat parameter.
     */

    @DISPID(1)
    // = 0x1. The runtime will prefer the VTID if present
    @VTID(8)
    void format(speech.types.ISpeechAudioFormat audioFormat);
    ...
    @VTID(9)
    int read(java.lang.Object buffer, int numberOfBytes);
    ...
    @VTID(10)
    int write(@MarshalAs(NativeType.VARIANT) java.lang.Object buffer);
    ...
    java.lang.Object seek(
            ...
            @Optional @DefaultValue("0") speech.types.SpeechStreamSeekPositionType origin);
