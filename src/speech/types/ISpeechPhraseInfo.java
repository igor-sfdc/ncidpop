...
public interface ISpeechPhraseInfo extends Com4jObject
{
    ...
    @VTID(14)
    speech.types.ISpeechPhraseRule rule();
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechPhraseProperties
     */

    @DISPID(9)
    // = 0x9. The runtime will prefer the VTID if present
    @VTID(15)
    speech.types.ISpeechPhraseProperties properties();

    @VTID(15)
    @ReturnValue(defaultPropertyThrough =
    { speech.types.ISpeechPhraseProperties.class })
    speech.types.ISpeechPhraseProperty properties(int index);
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechPhraseElements
     */

    @DISPID(10)
    // = 0xa. The runtime will prefer the VTID if present
    @VTID(16)
    speech.types.ISpeechPhraseElements elements();

    @VTID(16)
    @ReturnValue(defaultPropertyThrough =
    { speech.types.ISpeechPhraseElements.class })
    speech.types.ISpeechPhraseElement elements(int index);
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechPhraseReplacements
     */

    @DISPID(11)
    // = 0xb. The runtime will prefer the VTID if present
    @VTID(17)
    speech.types.ISpeechPhraseReplacements replacements();

    @VTID(17)
    @ReturnValue(defaultPropertyThrough =
    { speech.types.ISpeechPhraseReplacements.class })
    speech.types.ISpeechPhraseReplacement replacements(int index);
    ...
    @VTID(21)
    java.lang.String getText(@Optional @DefaultValue("0") int startElement,
     ...
     * @param elements Optional parameter. Default value is -1
     * @param useReplacements Optional parameter. Default value is false
     * @return Returns a value of type speech.types.SpeechDisplayAttributes
     */

    @DISPID(16)
    // = 0x10. The runtime will prefer the VTID if present
    @VTID(22)
    speech.types.SpeechDisplayAttributes getDisplayAttributes(
