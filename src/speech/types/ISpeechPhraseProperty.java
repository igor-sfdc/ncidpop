...
public interface ISpeechPhraseProperty extends Com4jObject
{
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechPhraseProperty
     */

    @DISPID(8)
    // = 0x8. The runtime will prefer the VTID if present
    @VTID(14)
    speech.types.ISpeechPhraseProperty parent();
    ...
    @VTID(15)
    speech.types.ISpeechPhraseProperties children();

    @VTID(15)
    @ReturnValue(defaultPropertyThrough =
    { speech.types.ISpeechPhraseProperties.class })
    speech.types.ISpeechPhraseProperty children(int index);
