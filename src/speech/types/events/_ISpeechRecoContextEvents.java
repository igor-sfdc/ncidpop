...
public abstract class _ISpeechRecoContextEvents
{
     ...
     * @param streamNumber Mandatory int parameter.
     * @param streamPosition Mandatory java.lang.Object parameter.
     * @param recognitionType Mandatory speech.types.SpeechRecognitionType
     *        parameter.
     * @param result Mandatory speech.types.ISpeechRecoResult parameter.
     */

    @DISPID(7)
    public void recognition(int streamNumber, java.lang.Object streamPosition,
            speech.types.SpeechRecognitionType recognitionType,
            speech.types.ISpeechRecoResult result)
    {
        throw new UnsupportedOperationException();
    }
     ...
     * @param streamNumber Mandatory int parameter.
     * @param streamPosition Mandatory java.lang.Object parameter.
     * @param interference Mandatory speech.types.SpeechInterference parameter.
     */

    @DISPID(12)
    public void interference(int streamNumber, java.lang.Object streamPosition,
            speech.types.SpeechInterference interference)
    {
        throw new UnsupportedOperationException();
    }
     ...
     * @param streamNumber Mandatory int parameter.
     * @param streamPosition Mandatory java.lang.Object parameter.
     * @param newState Mandatory speech.types.SpeechRecognizerState parameter.
     */

    @DISPID(14)
    public void recognizerStateChange(int streamNumber,
            java.lang.Object streamPosition,
            speech.types.SpeechRecognizerState newState)
    {
        throw new UnsupportedOperationException();
    }
