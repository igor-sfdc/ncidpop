...
public interface ISpeechLexiconPronunciations extends Com4jObject,
        Iterable<Com4jObject>
{
     ...
     * @return Returns a value of type speech.types.ISpeechLexiconPronunciation
     */
    ...
    @VTID(8)
    @DefaultMethod
    speech.types.ISpeechLexiconPronunciation item(int index);
