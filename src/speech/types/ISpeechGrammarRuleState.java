...
public interface ISpeechGrammarRuleState extends Com4jObject
{
     ...
     *         speech.types.ISpeechGrammarRuleStateTransitions
     */
    ...
    { speech.types.ISpeechGrammarRuleStateTransitions.class })
    speech.types.ISpeechGrammarRuleStateTransition transitions(int index);
     ...
     * </p>
     * 
     * @param destState Mandatory speech.types.ISpeechGrammarRuleState
     *        parameter.
     ...
     * </p>
     * 
     * @param destinationState Mandatory speech.types.ISpeechGrammarRuleState
     *        parameter.
