...
public interface ISpeechObjectTokenCategory extends Com4jObject
{
    ...
    @VTID(8)
    void _default(java.lang.String tokenId);
    ...
    @VTID(11)
    speech.types.ISpeechDataKey getDataKey(
            @Optional @DefaultValue("0") speech.types.SpeechDataKeyLocation location);
    ...
    @VTID(12)
    speech.types.ISpeechObjectTokens enumerateTokens(
