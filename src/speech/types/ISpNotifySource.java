...
public interface ISpNotifySource extends Com4jObject
{
    // Methods:
    /**
     * @param pNotifySink Mandatory speech.types.ISpNotifySink parameter.
     */

    @VTID(3)
    void setNotifySink(speech.types.ISpNotifySink pNotifySink);
    ...
    @VTID(5)
    void setNotifyCallbackFunction(Holder<java.nio.Buffer> pfnCallback,
    ...
    @VTID(6)
    void setNotifyCallbackInterface(Holder<java.nio.Buffer> pSpCallback,
            int wParam, int lParam);
