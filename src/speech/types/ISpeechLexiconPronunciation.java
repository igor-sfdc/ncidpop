...
public interface ISpeechLexiconPronunciation extends Com4jObject
{
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.SpeechLexiconType
     */

    @DISPID(1)
    // = 0x1. The runtime will prefer the VTID if present
    @VTID(7)
    speech.types.SpeechLexiconType type();
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.SpeechPartOfSpeech
     */

    @DISPID(3)
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(9)
    speech.types.SpeechPartOfSpeech partOfSpeech();
