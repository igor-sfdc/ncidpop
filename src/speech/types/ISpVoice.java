...
public interface ISpVoice extends speech.types.ISpEventSource
{
    ...
    @VTID(13)
    void setOutput(com4j.Com4jObject pUnkOutput, int fAllowFormatChanges);
   ...
   */
    ...
    @VTID(18)
    void setVoice(speech.types.ISpObjectToken pToken);
    ...
    @VTID(20)
    int speak(@MarshalAs(NativeType.Unicode) java.lang.String pwcs, int dwFlags);
    ...
    @VTID(21)
    int speakStream(speech.types.IStream pStream, int dwFlags);
    ...
    @VTID(23)
    int skip(@MarshalAs(NativeType.Unicode) java.lang.String pItemType,
            int lNumItems);
    ...
    @VTID(24)
    void setPriority(speech.types.SPVPRIORITY ePriority);
    ...
    @VTID(26)
    void setAlertBoundary(speech.types.SPEVENTENUM eBoundary);
