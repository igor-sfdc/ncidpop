...
public interface ISpeechLexicon extends Com4jObject
{
     ...
     * @return Returns a value of type speech.types.ISpeechLexiconWords
     */

    @DISPID(2)
    // = 0x2. The runtime will prefer the VTID if present
    @VTID(8)
    speech.types.ISpeechLexiconWords getWords(
            @Optional @DefaultValue("3") speech.types.SpeechLexiconType flags,
    ...
    void addPronunciation(
            ...
            int langId,
            @Optional @DefaultValue("0") speech.types.SpeechPartOfSpeech partOfSpeech,
    ...
    @VTID(13)
    speech.types.ISpeechLexiconPronunciations getPronunciations(
            java.lang.String bstrWord,
            @Optional @DefaultValue("0") int langId,
            @Optional @DefaultValue("3") speech.types.SpeechLexiconType typeFlags);
    ...
    @VTID(14)
    speech.types.ISpeechLexiconWords getGenerationChange(
