...
public interface ISpeechAudio extends speech.types.ISpeechBaseStream
{
    // Methods:
    /**
     * <p>
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechAudioStatus
     */

    @DISPID(200)
    // = 0xc8. The runtime will prefer the VTID if present
    @VTID(12)
    speech.types.ISpeechAudioStatus status();
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechAudioBufferInfo
     */

    @DISPID(201)
    // = 0xc9. The runtime will prefer the VTID if present
    @VTID(13)
    speech.types.ISpeechAudioBufferInfo bufferInfo();
    ...
    @VTID(14)
    speech.types.ISpeechAudioFormat defaultFormat();
    ...
    // = 0xcc. The runtime will prefer the VTID if present
    @VTID(18)
    void bufferNotifySize(int bufferNotifySize);
     ...
     * </p>
     * 
     * @param state Mandatory speech.types.SpeechAudioState parameter.
     */

    @DISPID(206)
    // = 0xce. The runtime will prefer the VTID if present
    @VTID(20)
    void setState(speech.types.SpeechAudioState state);
