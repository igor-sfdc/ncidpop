...
public interface ISpeechGrammarRule extends Com4jObject
{
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.SpeechRuleAttributes
     */
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechGrammarRuleState
     */

    @DISPID(2)
    // = 0x2. The runtime will prefer the VTID if present
    @VTID(8)
    speech.types.ISpeechGrammarRuleState initialState();
    ...
    @VTID(13)
    speech.types.ISpeechGrammarRuleState addState();
