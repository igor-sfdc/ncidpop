...
public interface ISpeechVoice extends Com4jObject
{
    ...
    // = 0x2. The runtime will prefer the VTID if present
    @VTID(9)
    void voice(speech.types.ISpeechObjectToken voice);
    ...
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(11)
    void audioOutput(speech.types.ISpeechObjectToken audioOutput);
     ...
     * </p>
     * 
     * @param audioOutputStream Mandatory speech.types.ISpeechBaseStream
     *        parameter.
     */
    ...
    // = 0x4. The runtime will prefer the VTID if present
    @VTID(13)
    void audioOutputStream(speech.types.ISpeechBaseStream audioOutputStream);
     ...
     * </p>
     * <p>
     * Setter method for the COM property
     * "AllowAudioOutputFormatChangesOnNextSet"
     * </p>
     * 
    ...
    @VTID(18)
    void allowAudioOutputFormatChangesOnNextSet(boolean allow);
     ...
     * </p>
     * <p>
     * Getter method for the COM property
     * "AllowAudioOutputFormatChangesOnNextSet"
     * </p>
     * 
     ...
     * </p>
     * 
     * @param eventInterestFlags Mandatory speech.types.SpeechVoiceEvents
     *        parameter.
     */
    ...
    // = 0x8. The runtime will prefer the VTID if present
    @VTID(21)
    void eventInterests(speech.types.SpeechVoiceEvents eventInterestFlags);
    ...
    @VTID(22)
    void priority(speech.types.SpeechVoicePriority priority);
    ...
    @VTID(24)
    void alertBoundary(speech.types.SpeechVoiceEvents boundary);
    ...
    @VTID(26)
    void synchronousSpeakTimeout(int msTimeout);
    ...
    @VTID(32)
    int skip(java.lang.String type, int numItems);
    ...
    @VTID(35)
    boolean waitUntilDone(int msTimeout);
    ...
    @VTID(38)
    void displayUI(int hWndParent, java.lang.String title,
