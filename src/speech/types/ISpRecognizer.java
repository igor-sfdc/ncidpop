...
public interface ISpRecognizer extends speech.types.ISpProperties
{
    ...
    @VTID(7)
    void setRecognizer(speech.types.ISpObjectToken pRecognizer);
    ...
    @VTID(9)
    void setInput(com4j.Com4jObject pUnkInput, int fAllowFormatChanges);
    ...
    @VTID(14)
    void setRecoProfile(speech.types.ISpObjectToken pToken);
   ...
   */
    ...
    @VTID(17)
    void setRecoState(speech.types.SPRECOSTATE newState);
    ...
    @VTID(22)
    void emulateRecognition(speech.types.ISpPhrase pPhrase);
