...
public interface ISpRecoGrammar extends speech.types.ISpGrammarBuilder
{
    ...
    @VTID(14)
    void loadCmdFromObject(GUID rcid,
    ...
    @VTID(15)
    void loadCmdFromResource(java.nio.Buffer hModule,
            ...
            short wLanguage, speech.types.SPLOADOPTIONS options);
    ...
    @VTID(17)
    void loadCmdFromProprietaryGrammar(GUID rguidParam,
            @MarshalAs(NativeType.Unicode) java.lang.String pszStringParam,
            java.nio.Buffer pvDataPrarm, int cbDataSize,
            speech.types.SPLOADOPTIONS options);
    ...
    @VTID(18)
    void setRuleState(@MarshalAs(NativeType.Unicode) java.lang.String pszName,
            java.nio.Buffer pReserved, speech.types.SPRULESTATE newState);
    ...
    @VTID(19)
    void setRuleIdState(int ulRuleId, speech.types.SPRULESTATE newState);
    ...
    @VTID(22)
    void setDictationState(speech.types.SPRULESTATE newState);
    ...
    @VTID(26)
    void setGrammarState(speech.types.SPGRAMMARSTATE eGrammarState);
    ...
    @VTID(27)
    Holder<Short> saveCmd(speech.types.IStream pStream);
