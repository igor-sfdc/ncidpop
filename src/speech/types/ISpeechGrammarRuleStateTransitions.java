...
public interface ISpeechGrammarRuleStateTransitions extends Com4jObject,
        Iterable<Com4jObject>
{
     ...
     *         speech.types.ISpeechGrammarRuleStateTransition
     */
    ...
    @VTID(8)
    @DefaultMethod
    speech.types.ISpeechGrammarRuleStateTransition item(int index);
