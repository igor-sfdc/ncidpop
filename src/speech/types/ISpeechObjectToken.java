...
public interface ISpeechObjectToken extends Com4jObject
{
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechDataKey
     */

    @DISPID(2)
    // = 0x2. The runtime will prefer the VTID if present
    @VTID(8)
    speech.types.ISpeechDataKey dataKey();
     ...
     * </p>
     * 
     * @return Returns a value of type speech.types.ISpeechObjectTokenCategory
     */

    @DISPID(3)
    // = 0x3. The runtime will prefer the VTID if present
    @VTID(9)
    speech.types.ISpeechObjectTokenCategory category();
    ...
    @VTID(10)
    java.lang.String getDescription(@Optional @DefaultValue("0") int locale);
    ...
    com4j.Com4jObject createInstance(
            ...
            @Optional @DefaultValue("23") speech.types.SpeechTokenContext clsContext);
    ...
    @VTID(14)
    void remove(java.lang.String objectStorageCLSID);
     ...
     * @param folder Mandatory speech.types.SpeechTokenShellFolder parameter.
     * @return Returns a value of type java.lang.String
     */
    ...
    @VTID(15)
    java.lang.String getStorageFileName(java.lang.String objectStorageCLSID,
            java.lang.String keyName, java.lang.String fileName,
            speech.types.SpeechTokenShellFolder folder);
    ...
    @VTID(16)
    void removeStorageFileName(java.lang.String objectStorageCLSID,
            java.lang.String keyName, boolean deleteFile);
    ...
    @VTID(17)
    boolean isUISupported(java.lang.String typeOfUI,
    ...
    @VTID(18)
    void displayUI(int hWnd, java.lang.String title, java.lang.String typeOfUI,
            @Optional @DefaultValue("") java.lang.Object extraData,
            @Optional com4j.Com4jObject object);
    ...
    @VTID(19)
    boolean matchesAttributes(java.lang.String attributes);
