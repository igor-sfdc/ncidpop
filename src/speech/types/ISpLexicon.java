...
public interface ISpLexicon extends Com4jObject
{
     ...
     * @param ePartOfSpeech Mandatory speech.types.SPPARTOFSPEECH parameter.
    ...
    void addPronunciation(
            ...
            short langId, speech.types.SPPARTOFSPEECH ePartOfSpeech,
    ...
    @VTID(6)
    void getGeneration(Holder<Integer> pdwGeneration);
