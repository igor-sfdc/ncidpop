...
public interface ISpeechPhraseElement extends Com4jObject
{
    ...
    @VTID(16)
    speech.types.SpeechDisplayAttributes displayAttributes();
    ...
    @VTID(17)
    speech.types.SpeechEngineConfidence requiredConfidence();
    ...
    @VTID(18)
    speech.types.SpeechEngineConfidence actualConfidence();
